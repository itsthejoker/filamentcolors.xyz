...
class TumblrRestClient(object):
    ...
    def likes(self, **kwargs):
        ...
        return self.send_api_request(
            "get", "/v2/user/likes", kwargs, ["limit", "offset", "before", "after"]
        )
    ...
    def following(self, **kwargs):
        ...
        """
        return self.send_api_request(
            "get", "/v2/user/following", kwargs, ["limit", "offset"]
        )
    ...
    def tagged(self, tag, **kwargs):
        ...
        return self.send_api_request(
            ...
            "/v2/tagged",
            kwargs,
            ["before", "limit", "filter", "tag", "api_key"],
            True,
        )
    ...
    def blog_likes(self, blogname, **kwargs):
        ...
        return self.send_api_request(
            "get", url, kwargs, ["limit", "offset", "before", "after"], True
        )
    ...
    def queue(self, blogname, **kwargs):
        ...
        return self.send_api_request(
            "get", url, kwargs, ["limit", "offset", "filter", "npf"]
        )
    ...
    def reblog(self, blogname, **kwargs):
        ...
        valid_options = ["id", "reblog_key", "comment"] + self._post_valid_options(
